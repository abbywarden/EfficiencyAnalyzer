...
parser = argparse.ArgumentParser(
                    ...
                    epilog='execution : python3 Efficiency_Analyzer.py --input_csv input_csv.csv')
...
#put into json
bad_ch[['Region','Chamber','Layer', 'Status']].to_json('problematic_chambers.json', orient = 'records')
...
bad_vfats = bad_vfats.groupby(['Region', 'Chamber', 'Layer']).apply(lambda x: x.drop(['Region', 'Chamber', 'Layer'], axis=1).to_dict(orient='records')).to_json('bad_vfats.json')
